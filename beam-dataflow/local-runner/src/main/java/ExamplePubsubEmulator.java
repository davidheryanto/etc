...
public class ExamplePubsubEmulator {
    ...
    public static class KVOfServiceTypeCustomerPrice extends DoFn<PubsubMessage, KV<String, Long>> {
        @ProcessElement
...
//            Double customerPrice = data.getDouble("customer_price", 0.0);
    ...
    public static class FormatOutput extends DoFn<KV<String, Long>, String> {
        ...
        public void processElement(ProcessContext c) {
            ...
            String out = String.format("[Service Type] %s: [Count] %s", elem.getKey(), elem.getValue());
            c.output(out);
        }
    }
