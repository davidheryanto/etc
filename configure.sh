...
sudo dnf -y install gcc wget gcc-c++ gcc-gfortran vim htop gnome-tweak-tool kdiff3 git nethogs mlocate unar rsync wine system-config-printer python-devel
